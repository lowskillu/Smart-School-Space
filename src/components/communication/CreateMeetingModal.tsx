...
import { Search, Users, User as UserIcon, X, Calendar, Video, Loader2, GraduationCap, ChevronRight, ChevronDown, Type } from "lucide-react";
...
interface CreateMeetingModalProps {
  ...
  onCreate: (data: { title: string; scheduled_time?: string; duration: number; participant_ids: string[]; class_ids: string[] }) => void;
}
      ...
      <DialogContent className="sm:max-w-[850px] bg-card/95 backdrop-blur-2xl border-primary/10 shadow-2xl p-0 overflow-hidden">
        <DialogHeader className="p-6 pb-2">
          <DialogTitle className="flex items-center gap-2 text-2xl font-black uppercase tracking-tighter italic">
            ...
            {t("communicationHub.modals.createMeeting")}
          </DialogTitle>
        </DialogHeader>
        ...
        <DialogFooter className="p-6 bg-primary/5 border-t border-primary/5">
          ...
          >
            {t("communicationHub.modals.meetingForm.actionCreate")}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
